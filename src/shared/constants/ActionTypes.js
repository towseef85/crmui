...
export const GET_VENDORPRICES="GET_VENDORPRICES";
...
export const GET_DRIVERSINGLE="GET_DRIVERSINGLE";
export const GET_DRIVERORDERS="GET_DRIVERORDERS";
export const POST_DRIVERORDERS="POST_DRIVERORDERS";
export const POST_DRIVER="POST_DRIVER";
export const PUT_DRIVER="PUT_DRIVER";
export const DELETE_DRIVER="DELETE_DRIVER";

//VENDOR ORDERS
export const POST_VENDORORDER="POST_VENDORORDER";
export const GET_VENDORORDERS="GET_VENDORORDERS";
export const GET_VENDORORDERSINGLE="GET_VENDORORDERSINGLE";
export const PUT_VENDORORDER="PUT_VENDORORDER";
export const DELETE_VENDORORDER="DELETE_VENDORORDER";

//ORDER
export const GET_ORDERSTATUS="GET_ORDERSTATUS";
export const GET_SINGLEORDERSTATUS="GET_SINGLEORDERSTATUS";
export const POST_ORDERSTATUS="POST_ORDERSTATUS";

//ORDERREQUEST
export const GET_ORDERREQUEST="GET_ORDERREQUEST";
export const GET_SINGLEORDERREQUEST="GET_SINGLEORDERREQUEST";

//VENDOR

export const GET_SINGLEVENDOR="GET_SINGLEVENDOR"


//SETTINGS
export const GET_PRICES='GET_PRICES';
export const GET_SINGLEPRICE='GET_SINGLEPRICE';
